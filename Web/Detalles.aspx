...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="centrado">
        <div class=" jumbotron centrado" style="width: 500px; height: 10px;">
            <h3><%=juegoDetalles.Nombre%> - <%=juegoDetalles.PlataformaJuego.Nombre %></h3>
        </div>
    </div>
    ...
    <div class="jumbotron" style="height: auto; width: auto; opacity: 0.9;">
        ...
        <br />
        <div class="card centrado" style="font-size: 15px; height: auto; width: auto; border-radius:10px;">
